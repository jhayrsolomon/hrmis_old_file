...
/**
 * PositionsSearch represents the model behind the search form of `frontend\modules\models\Positions`.
 */
class PositionsSearch extends Positions
{
    ...
    {
        return [
            [['id', 'salary_grades_id', 'position_name', 'position_code', 'created_at', 'updated_at'], 'safe'],
            [['deleted'], 'integer'],
        ];
    }
